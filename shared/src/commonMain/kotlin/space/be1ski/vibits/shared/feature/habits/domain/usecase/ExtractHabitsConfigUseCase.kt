...
class ExtractHabitsConfigUseCase {
  ...
  operator fun invoke(memos: List<Memo>, timeZone: TimeZone): List<HabitsConfigEntry> {
   ...
   */
  fun forDate(entries: List<HabitsConfigEntry>, date: LocalDate): HabitsConfigEntry? {
