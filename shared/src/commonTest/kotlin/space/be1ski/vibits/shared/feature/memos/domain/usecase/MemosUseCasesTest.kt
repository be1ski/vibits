...
class CreateMemoUseCaseTest {
  @Test
  fun `when invoke then delegates to repository`() =
    runTest {
...
class LoadMemosUseCaseTest {
  @Test
  fun `when invoke then returns memos from repository`() =
    runTest {
...
class LoadCachedMemosUseCaseTest {
  @Test
  fun `when invoke then returns cached memos from repository`() =
    runTest {
